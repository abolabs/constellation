                         ...
                         <div class="card-body">
                          ...
                          @foreach ($data as $key => $user)
                            <tr>
                              ...
                              <td>
                                <a class="btn btn-info" href="{{ route('users.show',$user->id) }}">{{ __('datatable.view') }}</a>
                                <a class="btn btn-primary" href="{{ route('users.edit',$user->id) }}">{{ __('datatable.edit') }}</a>
