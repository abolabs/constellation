...
const AppMenu = () => {
  ...
  return (
    ...
    >
      ...
      { open ? <Typography variant="h3">Administration</Typography> : <Divider /> }
      <Menu.Item to="/service_instance_dependencies" primaryText="Dépendances d'instances" leftIcon={<ShareIcon />} />
